      ...
      <div data-custom-class="body">
            ...
            <strong>
              <span style={{ fontSize: 15 }}>
                <span data-custom-class="subtitle">
                  Last updated <div className="question">May 15, 2024</div>
                </span>
              </span>
            </strong>
          </span>
              ...
              <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
                <span data-custom-class="body_text">
                  ...
                  <span style={{ color: "rgb(0, 58, 250)" }}>
                    <div className="question">
                      <a
                        href="http://www.nichita-r.com"
                        target="_blank"
                        data-custom-class="link"
                      >
                        http://www.nichita-r.com
                      </a>
                    </div>
                  </span>
                  <span style={{ fontSize: 15 }}>
        ...
        <div>
            ...
            <span style={{ fontSize: 15 }}>
              <span data-custom-class="body_text">
                <strong>
                  ...
                  <div className="block-component" />
                  types of <div className="statement-end-if-in-editor" />
                  parties do we share personal information?
                </strong>{" "}
                We may share information in specific situations and with
                specific <div className="block-component" />
                categories of <div className="statement-end-if-in-editor" />
          ...
          <div style={{ lineHeight: "1.5" }}>
            ...
            <a
              data-custom-class="link"
              href="https://app.termly.io/notify/47a81179-a598-4b03-b263-1fd67746108a"
